class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :phone_number, :email, :password, :password_confirmation, :gender, :bio, :state, :city, :profile_picture, :industry_id, :"birthdate(3i)", :"birthdate(2i)", :"birthdate(1i)" , :situation, :interest, :challenge, :goal])
  end
